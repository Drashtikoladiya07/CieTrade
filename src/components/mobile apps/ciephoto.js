...
function Ciephoto() {
    ...
    return (
        <div>
            ...
            <Container>
                <Row className='p-20'>
                    <Col lg={6}><img src="https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2022/08/ciephoto-phones.png.webp" className='w-5/6'></img></Col>
                    <Col lg={6} className=''>
            ...
            <Container>
                <Row className='py-20'>
                    ...
                    <Col lg={6}><img src="https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2022/08/photo-capture-570-x-570.png.webp" className='w-3/4'></img></Col>
                </Row>
            </Container>
            <Container>
                <Row className=' py-20'>
                    <Col lg={6}><img src="https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2022/08/loads-screen-570-x-570.png.webp" className='w-3/4'></img></Col>
                    <Col lg={6} className='content-center'>
            ...
            <Container>
                <Row className=' py-20'>
                    ...
                    <Col lg={6}><img src="https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2024/11/worksheet-ciePhoto.png.webp" className='w-4/5'></img></Col>
                </Row>
            </Container>
                ...
                <div className='py-5'>
                    <Container>
                        <Row>
                            ...
                            <Col lg={6}>
                                <center><img src="https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2022/08/ciedispatch-two-phones-1.png.webp" className='w-4/5'></img></center>
