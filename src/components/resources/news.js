                        ...
                        <Col lg={12} className="py-10" key={index}>
                            <Row>
                                ...
                                <Col lg={6}>
                                    ...
                                    <div className="pt-3"><a href="#" className="text-white bg-red-600 hover:bg-red-700 p-3 font-bold">Request Demo<i className="fa-solid fa-arrow-right ps-1 pt-1"></i></a></div>
                                </Col>
                            </Row>
                        </Col>
                    ))}
