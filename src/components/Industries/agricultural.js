...
function Agricultural() {
    ...
    const data = {
        ...
        Tool: [
            ...
            { img: mobile, head: "MOBILE APPS", title: "cieDispatch", p: "cieDispatch is a free mobile app that lets your drivers retrieve a list of assigned tickets, get directions to service locations, update job status, record notes, and even…" },
        ],
    };
    const faqs = [
        {
    ...
    return (
        <div>
            <div>
                <div className="relative bg-cover h-full" style={{ backgroundImage: `url('https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2022/08/dreamstime_m_34659237-scaled.jpg.webp')` }}>
                    ...
                    <div className="relative ps-32 py-40">
                        <h1 className="lg:text-7xl py-4 md:text-5xl sm:text-4xl text-white font-bold">Agricultural <br />Commodities Software</h1>
                ...
                <img src="https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2023/02/agriculture-trading-clients-logos-DARK.png.webp" className='w-100 img-fluid px-20 py-4 bg-light' />
            </div>

            <div className='py-5'>
                <Container>
                    <Row>
                        <h1 className='lg:text-4xl md:text-4xl sm:text-4xl text-center font-bold py-4'>Benefits of cieTrade's Agricultural Commodities Software</h1>
            ...
            <Container>
                <Row>
                    <h1 className='lg:text-4xl md:text-4xl sm:text-4xl text-center font-bold py-20'>Key Features of cieTrade's Agricultural Commodities Software</h1>
            ...
            <div className='text-center py-32'>
                ...
                <h1 className='lg:text-4xl md:text-3xl sm:text-3xl font-bold text-red-600 py-3'>Download our agricultural <br />commodities software brochure</h1>
