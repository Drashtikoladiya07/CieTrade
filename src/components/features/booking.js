    ...
    return (
        <div>
            ...
            <div className='px-4 bg-zinc'>
                <Row className='py-20'>
                    <Col lg={6} md={12}>
                            ...
                            <img src={Bookingonscreen} alt="booking" className='img-fluid' /></Col>

                    <Col lg={6} md={12} className=''>
                        <h1 className='lg:text-5xl md:text-4xl sm:text-2xl font-bold lh-sm'>Easily track and manage your export bookings and containers</h1>
                        ...
                        <div className='mt-3 '>
                            <a href={'/International'} className="border-3 font-bold border-red-600 text-red-600 font-bold py-4 px-3 me-2 ">see more features for exporters<i class="fa-solid fa-arrow-right ps-1 pt-1"></i></a>
                            <a href={'/Requestdemo'} className="text-white bg-red-600 hover:bg-red-700 py-4 font-bold px-3">Request Demo<i class="fa-solid fa-arrow-right ps-1 pt-1 "></i></a>
                        </div>
                    </Col>
                </Row>
            </div>
            ...
            <div className='bg-zinc-800 py-5'>
                ...
                <div className='py-5'><center><a href={'/Requestdemo'} className="text-white bg-red-600 hover:bg-red-700 px-4 py-4  font-bold text-base ">Request Demo<i class="fa-solid fa-arrow-right ps-3 pt-1"></i></a></center></div>
            </div>
            ...
            <Container>
                <Row className='py-10'>
                    ...
                    <Col lg={6} className='py-3' >
                        ...
                        <div className='py-3'> <a href={'/International'} className="text-red-600 font-bold text-base py-1 ">Learn More<i class="fa-solid fa-arrow-right text-white bg-red-600 text-sm p-1 rounded-3xl ms-2"></i></a></div>
                    </Col>
                    <Col lg={6} className='py-3'>
                        ...
                        <div className='py-3'> <a href={'/Ciephoto'} className="text-red-600 font-bold lg:text-base md:text-center sm:text-center">Learn More<i class="fa-solid fa-arrow-right text-white bg-red-600 text-sm p-1 rounded-3xl ms-2"></i></a></div>
                    </Col>
                </Row>
            </Container>
