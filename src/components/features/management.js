        ...
        <div className='text-white'>
            <div className="h-full relative bg-cover bg-center" style={{ backgroundImage: `url(https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2025/01/2025-01-28_14h16_20.png.webp)` }}>
                ...
                <div className="text-center relative pb-40 pt-56  ">
                    <h1 className="lg:text-7xl md:text-5xl sm:text-4xl font-bold leading-tight">Dispatch Management</h1>
                    <h1 className="lg:text-xl py-3 leading-tight">Dispatch management software for recyclers and waste brokers</h1>
                </div>
            </div>
            ...
            <div className='px-4 bg-zinc'>
                <Row className='py-20'>
                    ...
                    <Col lg={6} md={12} className=''>
                        <h1 className='lg:text-4xl md:text-3xl sm:text-2xl font-bold text-black lh-sm'>Easily manage both internal and third-party service jobs</h1>
            ...
            <div className='bg-zinc-800 py-5'>
                <h1 className='lg:text-4xl md:text-3xl sm:text-2xl font-bold lh-base text-center'>How cieTrade can help make your dispatch management more efficient</h1>
                <Row className='g-0 px-4'>
                    ...
                    <Col lg={3} md={6} className='pe-4 py-4'>
                        <div><i class="fa-solid fa-laptop text-red-600 text-5xl py-2"></i>
                            ...
                            <a href={'/Dispatch'}><button className='text-red-600 hover:text-red-700 font-bold pt-2'>learn More <i class="fa-solid fa-arrow-right ms-2 px-2 p-1 text-xs bg-red-600 text-white rounded-full"></i></button></a>
                        </div>
                    </Col>
                </Row>
            </div>
            ...
            <div className='px-3'>
                <Row className='g-0 py-20'>
                    <Col lg={6} className='py-20'>
                        <h6 className='lg:text-4xl md:text-3xl sm:text-2xl text-black font-bold py-4'>Dispatch Management</h6>
                    ...
                    <Col lg={6}><img src="https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2025/01/dispatch-board-2.png.webp" className=''></img></Col>
                </Row>
                <Row className='g-0 py-20'>
                    <Col lg={6}><img src="https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2025/01/route-management-1.png.webp" className=''></img></Col>
                    <Col lg={6} className='py-20'>
                        <h6 className='lg:text-4xl md:text-3xl sm:text-2xl text-black font-bold py-4'>Route Management</h6>
                ...
                <Row className='g-0 py-20'>
                    <Col lg={6} className='py-20'>
                        <h6 className='lg:text-4xl md:text-3xl sm:text-2xl text-black font-bold py-4'>Equipment Tracking</h6>
                    ...
                    <Col lg={6}><img src="https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2025/01/equipment-tracking.png.webp" className=''></img></Col>
                </Row>
                <Row className='g-0 py-20'>
                    <Col lg={6}><img src="https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2025/01/driver-assignment-2-1.png.webp" className=''></img></Col>
                    <Col lg={6} className='py-20'>
                        <h6 className='lg:text-4xl md:text-3xl sm:text-2xl text-black font-bold py-4'>Driver Assignments</h6>
            ...
            <div className='bg-zinc-800 py-20'>
                <h1 className='lg:text-5xl md:text-4xl sm:text-2xl font-bold lh-base 0 text-center'>Learn how cieTrade can help you improve</h1>
                <h1 className='lg:text-5xl md:text-4xl sm:text-2xl font-bold lh-sm text-center'>your dispatch management</h1>
