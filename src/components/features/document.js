        ...
        <div className='text-white'>
            <div className="h-full relative bg-cover bg-center" style={{ backgroundImage: `url(https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2025/01/2025-01-10_14h36_59.png.webp)` }}>
                ...
                <div className="text-center relative pb-40 pt-56  ">
                    <h1 className="lg:text-7xl md:text-5xl sm:text-4xl font-bold leading-tight">Document Management</h1>
                    <h1 className="lg:text-xl py-3 leading-tight">Document management software for recyclers and traders</h1>
                </div>
            </div>
            ...
            <div className='px-4 bg-zinc'>
                <Row className='py-20'>
                    ...
                    <Col lg={6} md={12} className=''>
                        <h1 className='lg:text-4xl md:text-3xl sm:text-2xl font-bold text-black lh-sm'>Generate and manage all of your specialized shipping and billing documents</h1>
            ...
            <div className='bg-zinc-800 py-5'>
                <h1 className='lg:text-4xl md:text-3xl sm:text-2xl font-bold lh-base text-center'>How cieTrade helps you manage documents more efficiently</h1>
            ...
            <div className='px-3'>
                <Row className='g-0 py-20'>
                    <Col lg={6} className='py-20'>
                        <h6 className='lg:text-4xl md:text-3xl sm:text-2xl text-black font-bold py-4'>Shipping & Billing Documents</h6>
                ...
                <Row className='g-0 py-20'>
                    ...
                    <Col lg={6} className='py-20'>
                        <h6 className='lg:text-4xl md:text-3xl sm:text-2xl text-black font-bold py-4'>Email Messages & Templates</h6>
                ...
                <Row className='g-0 py-20'>
                    <Col lg={6} className='py-20'>
                        <h6 className='lg:text-4xl md:text-3xl sm:text-2xl text-black font-bold py-4'>Document & Attachment Retrieval</h6>
                ...
                <Row className='g-0 py-20'>
                    ...
                    <Col lg={6} className='py-20'>
                        <h6 className='lg:text-4xl md:text-3xl sm:text-2xl text-black font-bold py-4'>Document Tracking</h6>
            ...
            <div className='bg-zinc-800 py-20'>
                ...
                <h1 className='lg:text-5xl md:text-4xl sm:text-2xl font-bold lh-sm text-center'>make document management easier</h1>
