        ...
        <div>
            <div>
                <div className="h-full relative bg-cover bg-center" style={{ backgroundImage: `url(https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2022/08/42-26814321-scaled.jpg.webp)` }}>
                    ...
                    <div className="text-center relative pt-56 pb-28">
                        <h1 className="lg:text-7xl py-3 md:text-5xl sm:text-4xl text-white text-center font-bold lh-xs">Inventory Management</h1>
                        <h1 className="lg:text-xl text-white pb-3 leading-tight">Take control of your paper stock, recovered fiber, or scrap material inventory</h1>
                ...
                <div className='bg-zinc-800'>
                    <Container >
                        <Row className='py-5'>
                            ...
                            <Col lg={6}>
                                <div className='flex py-3'><i class="fa-solid fa-check text-red-600 font-extrabold text-xl pe-3"></i><h6 className='text-base text-white font-semibold '> Tracks bulk material and serial (itemized) inventory by weight</h6></div>
                                <div className='flex py-3'><i class="fa-solid fa-check text-red-600 font-extrabold text-xl pe-3"></i><h6 className='text-base text-white font-semibold '> Supports both lot and perpetual (average cost) inventory accounting models </h6></div>
                                <div className='flex py-3'><i class="fa-solid fa-check text-red-600 font-extrabold text-xl pe-3"></i><h6 className='text-base text-white font-semibold '> Tracks material in real time by warehouse, lot, roll & skid number, raw/finished goods,condition, age and much more</h6></div>
                                <div className='flex py-3'><i class="fa-solid fa-check text-red-600 font-extrabold text-xl pe-3"></i><h6 className='text-base text-white font-semibold '> Supports user-definable product attribute combinations</h6></div>
                                <div className='flex py-3'><i class="fa-solid fa-check text-red-600 font-extrabold text-xl pe-3"></i><h6 className='text-base text-white font-semibold '> Provides material traceability by supplier and buyer</h6></div>
                                <div className='flex py-3'><i class="fa-solid fa-check text-red-600 font-extrabold text-xl pe-3"></i><h6 className='text-base text-white font-semibold '> Capitalizes storage charges or handling costs into existing inventory at any time</h6></div>
                                <div className='flex py-3'><i class="fa-solid fa-check text-red-600 font-extrabold text-xl pe-3"></i><h6 className='text-base text-white font-semibold '> Landed cost valuations capitalizing freight, storage, and processing costs</h6></div>
                            </Col>
                            <Col lg={6}>
                                <div className='flex py-3'><i class="fa-solid fa-check text-red-600 font-extrabold text-xl pe-3"></i><h6 className='text-base text-white font-semibold '>Provides barcode scanning support with customizable labels to save time and improve identification and accuracy of material movements & shipments</h6></div>
                                <div className='flex py-3'><i class="fa-solid fa-check text-red-600 font-extrabold text-xl pe-3"></i><h6 className='text-base text-white font-semibold '>Provides specialized reports and forms to make it easy to post inventory adjustments and capture physical counts</h6></div>
                                <div className='flex py-3'><i class="fa-solid fa-check text-red-600 font-extrabold text-xl pe-3"></i><h6 className='text-base text-white font-semibold '>Instant summary and detail reports on inventory position, roll forward, and inventor  valuation </h6></div>
                                <div className='flex py-3'><i class="fa-solid fa-check text-red-600 font-extrabold text-xl pe-3"></i><h6 className='text-base text-white font-semibold '>Increases overall visibility and control by reducing or eliminating cycle counts</h6></div>
                            </Col>
                        </Row>
                    </Container>
                </div>
            ...
            <div className='text-center py-32'>
                ...
                <h1 className='lg:text-4xl md:text-3xl sm:text-3xl font-bold text-red-600 py-3'>Download our inventory<br />management brochure</h1>
                <a href={'/Binventory'}><button className="bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-4 leading-tight">Download Brochure <i class="fa-solid fa-arrow-right ps-2"></i></button></a>
            </div>
