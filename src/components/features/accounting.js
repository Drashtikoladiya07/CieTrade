...
function Accounting() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "Yes, cieTrade gives you the flexibility to track more than one profit center or company on a single database. During the onboarding stage, you will be able to create multiple departments and select whether you would like to use our Multi-Department Accounting feature.",
        },
    ];
    ...
    const data = {
        Logo:
            [
                { img: Logo1, deatail: "QuickBooks Desktop Pro is our most widely used accounting integration option. Transactions flow directly from cieTrade into QB company files using our internal Transaction Manager tool. Supports posting to multiple companies from one cieTrade database by allowing cieTrade departments to be mapped to different QB company files." },
                { img: Logo2, deatail: "Our seamless, real-time integration with QuickBooks Online uses the same transaction manager tool for QB Desktop. While upgrading QB from their desktop software to the cloud is relatively easy, there are a number of steps and potential complexities doing this for cieTrade. If you plan to make this change it needs to be coordinated with our support team in advance." },
                { img: Logo3, deatail: "We continue to offer integration with SAGE 50 (formerly Peachtree Accounting)." },
                { img: Logo4, deatail: "SAGE 500 is an enterprise desktop accounting platform widely used by many of our largest clients worldwide. cieTrade’s integration for this platform is very robust, stable and has been supported for several years. It offers advanced multi-currency and multi-company consolidation." },
                { img: Logo5, deatail: "Sage Intaact is an enterprise cloud based ERP platform and natural successor to Sage500 for clients looking to migrate to a cloud based solution. We offer real-time integration that works very much like Sage500 including multi-currency, intercompany, and multi-company consolidation. Unlike some other cloud options, our integration uses a local .DLL and offers advantages over web APIs." },
                { img: Logo6, deatail: "NetSuite is an enterprise oriented cloud based ERP platform for which we offer real-time integration. Like Intacct, our integration methods use a local .DLL instead of making web API calls. It includes multi-currency support but we do not currently offer multi-company support as of yet. This is a newer offering and we have a limited number of clients on this platform at the present time." },
                { img: Logo7, deatail: "Microsoft Dynamics 365 Business Central is a cloud based accounting and financials platform offered by Microsoft for mid-market companies for which we offer real-time integration. It offers a step up from Quickbooks and other starter platforms with more features for larger companies." },
                { img: Logo8, deatail: "Xero is a cloud based accounting platform for small businesses. Integration with this accounting solution is currently available for clients on our cloud software and could be made available for desktop clients upon request." },
                { img: Logo9, deatail: "Zoho Books is an online accounting software designed for small businesses to manage their financials. Integration with this accounting solution is currently available for clients on our cloud software and could be made available for desktop clients upon request." },
            ],
    };
    return (
        <div>
            <div className="h-full relative bg-cover   " style={{ backgroundImage: `url(https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2022/08/P1RBW5-scaled-e1661794714325.jpg.webp)` }}>
                ...
                <div className="text-center relative py-40">
                    <h1 className="lg:text-7xl md:text-5xl sm:text-4xl text-white font-bold leading-tight">Accounting Integration</h1>
                    <h1 className="lg:text-xl text-white py-3 leading-tight">Instantly updates your accounting software to avoid double entry</h1>
                </div>
            </div>
            <div className='bg-light py-5'>
                <center><i class="fa-solid fa-link text-red-600 text-5xl"></i></center>
                <h1 className='lg:text-3xl md:text-2xl  font-bold lh-base py-2 0 text-center'>Works with QuickBooks, Sage, Xero and more</h1>
                <h1 className='text-xl lh-base text-gray-600 text-center px-24'>Our “best of breed” approach to accounting integration doesn’t force you to use a proprietary accounting system, letting you select the software that’s right for your business instead of being locked into a proprietary accounting system. Our real-time accounting link saves time and minimizes errors by automatically synchronizing master data and transaction postings without the use of manual batch files that can easily lead to reconciliation headaches. It can even pull back information such as payment status that can reduce inquiries and minimize access to your books.</h1>
            ...
            <Container className=''>
                ...
                {data.Logo.map((item, index) => (
                    <Col lg={4} key={index} className='py-5' >
                        <center><a><img src={item.img} className='w-2/3 py-3'></img></a></center>
                        <h6 className='text-xl text-gray-500 text-center'>{item.deatail}</h6>
                    </Col>
                ))}
                </Row>
            </Container>
            ...
            <div className='bg-gray-900'>
                <Container >
                    <Row className='py-5'>
                        <h1 className='lg:text-5xl md:text-3xl sm:text-2xl font-bold lh-base text-center text-white py-5'>Key Features of cieTrade's Accounting Integration </h1>
                        <Col lg={6}>
