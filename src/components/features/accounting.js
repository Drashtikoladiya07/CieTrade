...
function Accounting() {
    ...
    const data = {
        Logo: [
            { id: "https://quickbooks.intuit.com/ca/desktop/pro/", img: Logo1, deatail: "QuickBooks Desktop Pro is our most widely used accounting integration option. Transactions flow directly from cieTrade into QB company files using our internal Transaction Manager tool. Supports posting to multiple companies from one cieTrade database by allowing cieTrade departments to be mapped to different QB company files." },
    ...
    return (
        <div>
            ...
            <div className='bg-light py-5'>
                ...
                <h1 className='text-lg lh-base text-gray-600 text-center px-24'>Our “best of breed” approach to accounting integration doesn’t force you to use a proprietary accounting system, letting you select the software that’s right for your business instead of being locked into a proprietary accounting system. Our real-time accounting link saves time and minimizes errors by automatically synchronizing master data and transaction postings without the use of manual batch files that can easily lead to reconciliation headaches. It can even pull back information such as payment status that can reduce inquiries and minimize access to your books.</h1>
            </div>
