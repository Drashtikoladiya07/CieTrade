        ...
        <div>
            <div className="relative bg-cover bg-center h-full" style={{ backgroundImage: `url('https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2022/05/Mask-Group-30.png.webp')` }}>
                ...
                <div className="relative pt-56 pb-44">
                    <h1 className="lg:text-7xl py-4 md:text-5xl sm:text-4xl text-white text-center font-bold lh-xs">Our Story</h1>
                    <p className="lg:text-xl text-white text-center">cieTrade was launched in 1999 but our story really begins a few years earlier as an idea <br/>discussed over lunch between Richard Hamilton and David Haber.</p>
                </div>
            </div>
