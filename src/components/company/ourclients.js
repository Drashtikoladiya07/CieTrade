...
// function ClientTestimonialCard({ icon, description, title }) {
//     return (
//         <div className="bg-white shadow-md hover:shadow-lg transition-shadow duration-300 h-full p-6 rounded-xl flex flex-col justify-between">
//             <img src={icon} alt="Client Logo" className="object-contain h-20 mx-auto" />
//             <p className="text-lg italic text-center mt-4 mb-2">"{description}"</p>
//             <h6 className="text-gray-600 text-center font-semibold">{title}</h6>
//         </div>
//     );
// }
...
//         Client: [
//             {
//                 icon: "https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2023/02/integrity-recycling-logo-black.png.webp",
//                 description: "For nearly two decades, cieTrade has allowed our company to grow and adapt in every aspect of the recycling and waste industry. No other industry software comes close to cieTrade's support and capabilities.",
//                 title: "Ralph Giordano, President"
//             },
//             {
//                 icon: "https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2023/02/CNA-Metals-logo-1.png.webp",
//                 description: "cieTrade continues to amaze us. The software and integrated portal have really opened up opportunities to grow our business and differentiate us among our competitors while their support team has provided a level of service we have never experienced before.",
//                 title: "Hari Agrawal, CEO"
//             },
//             {
//                 icon: "https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2023/02/select-trading-logo.png.webp",
//                 description: "With cieTrade, everything from trade profitability to shipping statistics are instantly available, keeping us on target day in and out. cieTrade has become an invaluable part of our operation and a critical tool to help us grow our business.",
//                 title: "Eddie San Giacomo, CEO"
//             },
//             {
//                 icon: "https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2023/06/Untitled-design-1.png.webp",
//                 description: "With cieTrade, everything from trade profitability to shipping statistics are instantly available, keeping us on target day in and out. cieTrade has become an invaluable part of our operation and a critical tool to help us grow our business.",
//                 title: "Jesse Roberts, VP"
//             },
//             {
//                 icon: "https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2023/06/Untitled-design-2.png.webp",
//                 description: "cieTrade has proved to be invaluable in helping us grow and stay competitive, dramatically lowering our operating costs, providing critical data for decision making, and improving service for customers and suppliers.",
//                 title: "Jeffrey Levit, President & CEO"
//             },
//             {
//                 icon: "https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2023/06/Untitled-design-3.png.webp",
//                 description: "cieTrade has allowed us to completely organize our business, helping us improve organization of data, equipment tracking, service management and providing critical insight into profitability.",
//                 title: "Tyler Yaldo, Founder"
//             },
//         ],
//     }
...
//             <div className="w-full relative bg-cover bg-center" style={{ backgroundImage: `url(https://i.ytimg.com/vi/oBY6wR2FAqk/maxresdefault.jpg)` }}>
//                 <div className='absolute inset-0 bg-black opacity-50'></div>
//                 <div className="text-center relative pb-32 pt-52 px-4">
//                     <h1 className="text-4xl md:text-6xl text-white font-bold leading-tight">Our Clients</h1>
//                     <p className="text-base md:text-xl text-white py-3 max-w-5xl mx-auto">
//                         cieTrade has a diverse worldwide customer base that’s transacted billions in goods and shipped hundreds of thousands of containers on our software. Our clients include many of the leading trading houses, scrap exporters, and recycling plants. cieTrade’s flexible design has also attracted waste brokers and national accounts consolidators looking to avoid using spreadsheets or expensive custom systems.
//                     </p>
//                 </div>
//             </div>

//             <Container fluid className="px-4 md:px-20 py-10">
//                 <Row className='align-items-center py-16'>
//                     <Col lg={6} className='mb-4 mb-lg-0'>
//                         <YouTubeEmbed videoId="mwtsCFbxXa4" />
//                     </Col>
//                     <Col lg={6}>
//                         <h6 className='pt-3 font-bold text-xl text-red-600'>SUCCESS STORY</h6>
//                         <h3 className='text-3xl font-bold py-3'>Wasteology</h3>
//                         <p className='text-gray-600 text-lg'>Learn how Wasteology, a waste and recycling services broker, eliminated double-entry, streamlined dispatch management and improved their billing process with cieTrade’s industry-specific software, tailored to meet evolving needs as their operation scales.</p>
//                         <div className='pt-6'>
//                             <a href='https://youtu.be/mwtsCFbxXa4' className="text-white bg-red-600 hover:bg-red-700 px-4 py-3 font-bold inline-block rounded">Watch Success Story<i className="fa-solid fa-arrow-right ps-3 pt-1"></i></a>
//                         </div>
//                     </Col>
//                 </Row>
...
//                     <Col lg={6}>
//                         <h6 className='pt-3 font-bold text-xl text-red-600'>SUCCESS STORY</h6>
//                         <h3 className='text-3xl font-bold py-3'>AP&J Recycling</h3>
//                         <p className="text-gray-600 text-lg">
//                                 As a rapidly growing plastics recycling business, AP&J Recycling needed an industry-specific
//                                 solution to be able to manage their operation. Learn how cieTrade helped eliminate manual
//                                 spreadsheets, improve inventory tracking and increase accuracy of COGS.
//                             </p>                        <div className='pt-6'>
//                             <a href='https://youtu.be/mehip29GhNI' className="text-white bg-red-600 hover:bg-red-700 px-4 py-3 font-bold inline-block rounded">Watch Success Story<i className="fa-solid fa-arrow-right ps-3 pt-1"></i></a>
//                         </div>
//                     </Col>
//                 </Row>
...
//                     <Col lg={6}>
//                         <h6 className='pt-3 font-bold text-xl text-red-600'>SUCCESS STORY</h6>
//                         <h3 className='text-3xl font-bold py-3'>Canusa Hershman</h3>
//                         <p className="text-gray-600 text-lg"> Lack of real-time integration with accounting software proved to be problematic for Canusa Hershman. cieTrade helped by handling transactions faster, allowing them to grow from a domestic to an international trader</p>                        
//                             <div className='pt-6'>
//                             <a href='https://youtu.be/oBY6wR2FAqk' className="text-white bg-red-600 hover:bg-red-700 px-4 py-3 font-bold inline-block rounded">Watch Success Story<i className="fa-solid fa-arrow-right ps-3 pt-1"></i></a>
//                         </div>
//                     </Col>
//                 </Row>
...
//                     <Col lg={6}>
//                         <h6 className='pt-3 font-bold text-xl text-red-600'>SUCCESS STORY</h6>
//                         <h3 className='text-3xl font-bold py-3'>The Paper Tigers</h3>
//                         <p className="text-gray-600 text-lg"> 
...
//                         </p>                        
//                             <div className='pt-6'>
//                             <a href='https://youtu.be/yxcsJQlRxAk' className="text-white bg-red-600 hover:bg-red-700 px-4 py-3 font-bold inline-block rounded">Watch Success Story<i className="fa-solid fa-arrow-right ps-3 pt-1"></i></a>
//                         </div>
//                     </Col>
//                 </Row>

//                 {/* Testimonials Section */}
//                 <div className='bg-gray-100 py-10 mt-10 rounded-xl'>
//                     <h2 className='text-3xl md:text-4xl text-center font-bold mb-10'>What Our Clients Are Saying</h2>
//                     <Row>
//                         {data.Client.map((item, index) => (
//                             <Col key={index} lg={4} md={6} sm={12} className="mb-4 px-3">
