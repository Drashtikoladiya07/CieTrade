        ...
        <div>
            <div className="w-full relative bg-cover bg-center" style={{ backgroundImage: `url(https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2023/05/shutterstock_239752759-scaled.jpg.webp)` }}>
                ...
                <div className="text-center relative  pb-40 pt-56">
                    <h1 className="lg:text-7xl md:text-5xl sm:text-4xl text-white font-bold leading-tight">cieTrade helps iSustain Recycling<br /> maximize business performance</h1>
                    <h1 className="lg:text-xl text-white py-3 leading-tight">Learn how iSustain increased their operational efficiency and improved financial accuracy by leveraging cieTrade’s workflow <br />features and integrated accounting tools.</h1>
                </div>
            </div>
            <Container>
                <Row>
                    {data.time.map((item, index) => (
                        <Col lg={3} md={6} sm={12} className='border hover:shadow-lg p-4 text-center g-0' key={index}>
                            <div className=''>
                                <div className='m-'>
                                    <h1 className='font-bold text-red-600 text-4xl pt-3 '>{item.per}</h1>
                                    <h1 className='font-bold text-2xl text-black py-3'>{item.descrip}</h1>
                                </div>
                            </div>
                        </Col>
                    ))}
            ...
            <Container>
                <Row className=' py-20'>
                    <Col lg={6}><center><img src="https://www.cietrade.com/wp-content/webp-express/webp-images/uploads/2023/06/iSustainLogo-2-300x240.png.webp" className='w-2/5 py-4'></img></center></Col>
                    <Col lg={6} className='content-center'>
                        <h6 className='lg:text-3xl md:text-3xl sm:text-2xl text-black font-bold'>  Introduction</h6>
            ...
            <Container className='py-4'>
                <h6 className='lg:text-3xl md:text-3xl sm:text-2xl text-black font-bold'>The Challenge</h6>
            ...
            <Container className='py-4'>
                <h6 className='lg:text-3xl md:text-3xl sm:text-2xl text-black font-bold'>The Solution</h6>
            ...
            <Container className='py-4'>
                <h6 className='lg:text-3xl md:text-3xl sm:text-2xl text-black font-bold'>Results</h6>
