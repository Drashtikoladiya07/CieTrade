        ...
        <div>
            ...
            <Container>
                <div className="pt-20 lg:px-7 md:px-0 sm:px-0">
                    ...
                    <h2 className="text-red-600 py-2">January 21, 2022 / <a href={'/Pastevent'} className="hover:text-gray-700">Product Updates</a></h2>
                    ...
                    <p className="text-gray-500 py-3">To learn more about cieMobile, visit <a href="" className="text-red-600 hover:text-gray-700 underline">Mobile CRM App | cieMobile</a> or contact the Support Team at 203.323.0074.</p>
